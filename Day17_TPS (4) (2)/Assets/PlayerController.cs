...
public class PlayerController : MonoBehaviour
{
    ...
    public bool IsEquipped {
        get
        {
            return RightweaponHolder != null && RightweaponHolder.childCount > 0;
        }
    }

    public bool IsEquipped1
    {
        get
        {
            return LeftweaponHolder != null && LeftweaponHolder.childCount > 0;
        }
    }
    ...
    void Disarm()
    {
        if (IsEquipped)
        {
            Transform weapon = RightweaponHolder.GetChild(0);
    ...
    void Disarm1()
    {
        if (IsEquipped1)
        {
            Transform weapon = LeftweaponHolder.GetChild(0);
            weapon.SetParent(weaponDisarmHolder);
            anim.SetInteger("HoldingWeaponId", 0);
        }
    }
    ...
    void Equip()
    {
        if (IsDisarmed)
        {
            ...
            weapon.SetParent(RightweaponHolder);
